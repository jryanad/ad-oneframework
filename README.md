...
To use the framework, just define oneframework as a dependency in your assets.json file and copy layout.scss & site-setting.scss into your CSS directory and make sure to update the import paths.
...
# The JS
Plugins used by oneframework are now self-contained within the framework itself but MUST be called individually from within your assets.json file as needed.
